...
class BigDigitsView extends WatchUi.WatchFace {
    var font_seconds;
    var font_hr;
    ...
    function onLayout(dc) {
        ...
        label_datehr = View.findDrawableById("DateHR");
    }
    ...
    function onUpdate(dc) {
        ...
        label_hour.setLocation(label_minutes.locX - dc.getTextWidthInPixels(textMinutes, WatchUi.loadResource(Rez.Fonts.id_delirium_200px)), label_minutes.locY);
